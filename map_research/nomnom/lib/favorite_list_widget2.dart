...
class FavoriteListWidget2 extends StatefulWidget {
  final FavoriteManager manager;

  FavoriteListWidget2({@required this.manager}) : assert(manager != null);

  @override
  State<StatefulWidget> createState() => new _FavoriteListState2();
}

class _FavoriteListState2 extends State<FavoriteListWidget2> {
